  ...
  return (
    <>
      ...
      <main className=" font-body px-10 pb-10 bg-palette-beige min-h-screen">
        ...
        <section id="about-me" className=' text-center pt-20 max-w-screen-md  mx-auto'>
          <h2 className=" text-5xl my-2 font-heading text-palette-pink">Vanessa Marie Tan</h2>
          <h3 className=" text-2xl mb-2 font-heading text-palette-pink">Software Developer and Certified Public Accountant.</h3>
        ...
        <section id="my-projects" className='mt-10 max-w-screen-md mx-auto'>
          ...
          <div className=" pl-5 relative w-full">
            ...
            <p className=' text-gray-900 font-bold'>
            Brewcipe is a coffee recipe sharing app. Try out new recipes from fellow coffee aficionados. Or share your own delicous recipe for others to try out.</p>
        ...
        <section id="contacts" className='mt-10 max-w-screen-md mx-auto'>
